...
@Component({
  selector: 'match-logic-view',
  templateUrl: './match-logic-view.component.html',
  styleUrls: ['./match-logic-view.component.scss']
})

export class MatchLogicViewComponent implements OnInit {
  @Input() enode: Enode;
